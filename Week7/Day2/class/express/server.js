...
app.use('/main',express.static(__dirname + '/fetching'))
...
//config - conect to db
//modules - simple queries, queri from DB
//controlers -solve promise, discribe the function to solve the queri(the promise)
// router - calls the function from controller, solve it and send it to server (gets the controller to send response for the )
