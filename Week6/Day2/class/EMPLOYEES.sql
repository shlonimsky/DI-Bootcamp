  CREATE SEQUENCE INCREMENTID1
  INCREMENT 10
  START 10;

  CREATE TABLE EMPLOYEE
  (
     EmpCode      integer PRIMARY KEY NOT NULL DEFAULT nextval('INCREMENTID1'),
...
CREATE TABLE DEPARTMENT ( 
  DEPTCODE INTEGER PRIMARY KEY NOT NULL DEFAULT nextval('INCREMENTID1'), 
  DeptName CHAR(30), 
